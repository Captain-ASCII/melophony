...
export default class Log {
  ...
  static LOG_LEVEL = LOG_LEVELS.WARNING


  static d(msg: any, object: any = undefined): void {
    if (Log.LOG_LEVEL >= LOG_LEVELS.DEBUG) {
      console.debug(msg, object)
    }
  }

  static i(msg: any, object: any = undefined): void {
    if (Log.LOG_LEVEL >= LOG_LEVELS.INFO) {
      console.log(msg, object)
    }
  }

  static w(msg: any, object: any = undefined): void {
